    ...
    return (
        <nav className='bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark p-4 relative'>
            <div className='container flex mx-auto justify-between items-center'>
                ...
                <div id="navbarMenu" className={`absolute top-full left-0 w-full text-center bg-background-light dark:bg-background-dark z-10 transform origin-top duration-500 ${isOpen ? 'scale-y-100' : 'scale-y-0'} md:scale-y-100 md:relative md:flex md:flex-row md:items-center md:w-auto md:bg-transparent transition-transform duration-300 ease-in-out`}>
